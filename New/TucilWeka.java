    ...
    public static void main(String[] args) throws Exception {
		...
		if(main==1){
			...
			try {
				cls = loadModel(name);
				//Input training file
				br = new BufferedReader(new FileReader("C:\\Users\\HP\\Desktop\\Team_test.arff"));
			...
			try {
				//Input training file
				br = new BufferedReader(new FileReader("C:\\Users\\HP\\Desktop\\student-train.arff"));
				data = new Instances(br); 
				
				br = new BufferedReader(new FileReader("C:\\Users\\HP\\Desktop\\student-mat-test.arff"));
				doto = new Instances(br);
				...
				options[3] = "0.0";
                                ...
                                int q;
                                    System.out.println(data.attribute(27));
				Normalize norm = new Normalize();                         // new instance of filter
				norm.setOptions(options);                           // set options
				norm.setInputFormat(data);  
                                
				Standardize std = new Standardize();                           // set options
				std.setInputFormat(data);
// inform filter about dataset **AFTER** setting options
				train = Filter.useFilter(data, norm);   // apply filter
				doto = Filter.useFilter(doto, norm); 
